...
export default function HeroContent() {
  ...
  return (
    <div className="space-y-8">
      ...
      >
        <h1 className="text-5xl sm:text-6xl lg:text-[5.5rem] font-script font-bold text-burgundy leading-[1.1] tracking-wide px-2 md:px-0 drop-shadow-sm">
          Aşk Hikayenizi<br className="hidden sm:block" /> Dijitalleştirin
        </h1>
        <h2 className="text-lg sm:text-xl text-burgundy/90 leading-relaxed font-light max-w-2xl">
      ...
      >
        <button className="px-8 py-4 bg-[#7b1113] text-white rounded-lg hover:opacity-90 transition-colors font-medium text-center">
          Ücretsiz Başla
        </button>
